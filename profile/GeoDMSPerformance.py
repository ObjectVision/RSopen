...
#
# Dit script meet en vergelijkt de rekenprestaties van GeoDMS-runs. Het voert experimenten uit, slaat resultaten op (pickle), en genereert interactieve Bokeh-grafieken voor analyse van performance-verschillen tussen configuraties.
#
# ================================================================================
