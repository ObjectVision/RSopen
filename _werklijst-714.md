...
| 2 | ccb31b4c voetafdruk langs einde-jaars afleiding | geslaagd, exact | Drie toetsrondes. De eerste gaf 7,37 miljoen m2 verschil over 372.590 cellen: de werkentak miste dat #710 verzorgende banen met het woonpakket laat meekomen en telde die dubbel. De reparatie daarvan schoot door en gaf 3,01 miljoen m2 over 20.117 cellen de andere kant op: het behoud van de verzorgende voetafdruk op door wonen gewonnen cellen ontbrak. De splitsingsmeting wees dat aan, de derde tak volgt nu de keten, en de derde toets geeft exact nul op alle zes de subsectoren en op wonen, over alle cellen en alle drie de maten |
...
| geslaagd, exact | 1 | gezakt, tweemaal gerepareerd, en de derde toets geeft exact nul op alle maten (#2) |
...
- De voetafdrukafleiding is af: de derde equivalentietoets geeft exact nul. Wat #716 nog draagt is de klemasymmetrie zelf, dat de startstand de voetafdruk op het celoppervlak klemt en de iteratie-update en de afleiding geen van beide; die is nu aantoonbaar geen bron van verschil tussen de twee ketens, maar de 60.769 cellen boven het celoppervlak bestaan nog steeds.
