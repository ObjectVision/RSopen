...
| 2 | #721 en #723 hernoeming van de 26 NbS-pakketten | geen blokkade gebleken | De `Opbrengsten_perOP`-tifs droegen de oude namen, dus 26 van de 53 waren per set onvindbaar, en die set heeft geen fingerprint die dat signaleert. De productiereeks van 1 september is er echter zonder mankeren doorheen gelopen voor alle drie de varianten: de variantdatastap genereert de set onder de nieuwe namen opnieuw, dus de zichtjaargeschiktheid struikelt er niet over. Wat blijft staan is dat niets zou hebben gewaarschuwd als dat wel was gebeurd |
...
| 10 | #664 9a/9b-water als voorkeurslocatie | geslaagd, zwakker dan de toelichting belooft | De kruising bestond niet en is gebouwd als `Diagnose724/D664`. Gemeten in NbSGenuanceerd Y2040: van de 2.872,4 ha gealloceerde berging valt 1.492,6 ha op het 9a/9b-water, dus 52,0 procent, terwijl dat water nog geen procent van het studiegebied beslaat. De voorkeursterm stuurt dus onmiskenbaar. Hij stuurt wel zwakker dan de Descr bij `Weight_VeenWater_Waterberging` belooft, want die noemt bij gewicht 1,0 een vrijwel strikte rangorde: er blijft 22.874,5 ha veenwater onbenut, oftewel 93,9 procent, terwijl 1.379,8 ha berging elders landt. De waarschijnlijke oorzaak staat in diezelfde Descr en is niet de geschiktheid maar de zeef, want de dieptetoets eist een waterschijf van minstens een meter en het 9a-water is ondiep. Dat laatste is een hypothese en geen meting |
...
Drieendertig van de 76 NVM-regio's halen de woningclaim niet, met 0,7327 als laagste, tegen elf regio's in BAU en BAU2 met 0,8789 als laagste. Landelijk valt daar niets van te zien: de realisatie is 0,9948 tegen 0,9953. Uitgedrukt in woningen, uit de claimrealisatietabel van #693: NbSGenuanceerd heeft 559.630 woningen tekort in de ene regio en 504.496 over in de andere, tegen 128.316 en 77.905 in de referentievarianten. De variant bouwt dus niet minder woningen. Het overschot zit bovendien niet in regio's waar te veel wordt gebouwd maar volledig in regio's die hun claim al voor de allocatie hadden gehaald, 27 bij BAU en 37 bij NbSGenuanceerd; daar kan het model niets mee, want het doel staat op max(restclaim, 0). De zuivere maat is wat er in de regio's met een restclaim gebeurt, en daar haalt BAU er 41 van de 49 op norm en NbSGenuanceerd 12 van de 39. Onafhankelijk bevestigd met /Diagnose/claimtoets, dat op min 559.630,56 en min 128.316,28 uitkomt. De grootste tekorten zitten in Zwolle (41.562), Almere (37.785) en Waterland (21.569).
